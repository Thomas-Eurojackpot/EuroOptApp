    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("F2-Frequenz wird nur auf die 5 Hauptzahlen angewendet. Die Eurozahlen bleiben vollständig in der Alpha-Auswahl.").foregroundStyle(.secondary)
                ...
                Button { run() } label: {
                    ...
                    else { Label("Alpha + F2-Hauptzahlen-Test starten", systemImage: "chart.bar.xaxis").frame(maxWidth: .infinity) }
                }
