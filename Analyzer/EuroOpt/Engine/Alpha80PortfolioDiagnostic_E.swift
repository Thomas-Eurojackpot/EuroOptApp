...
final class Alpha80PortfolioDiagnostic_E {
    ...
    var controlDThreePlus = 0

        var controlEExact21 = 0

        var controlEThreePlus = 0

        var controlETickets = 0

    var controlDTickets = 0
        ...
        for index in warmup..<totalDraws {
            ...
            let controlC = selectPortfolio(
                ...
                diversityBonusMultiplier: 0.75

            )

            let controlD = selectPortfolio(

                scored: Array(scored.prefix(min(27, scored.count))),

                limit: ticketCount,

                diversityBonusMultiplier: 1.00

            )

            let controlE = selectCoverageTarget(
            ...
            evaluateControl(
                ...
                exact21: &controlDExact21,

                threePlus: &controlDThreePlus,

                ticketTotal: &controlDTickets
            ...
            evaluateControl(
                ...
                exact21: &controlEExact21,

                threePlus: &controlEThreePlus,

                ticketTotal: &controlETickets
            ...
            for strategy in Strategy.allCases {
                ...
                case .portfolio:
                    ...
                    // E = Top-27 / Coverage Target

                    selected = selectCoverageTarget(
        ...
        print("Zufall       | \(atLeast21Random) | \(Double(round(randomPercent * 10.0) / 10.0))% |      —")
        ...
        print("A/B/C/D/E AUSWAHLTEST")

        print("==============================================")

        print("A = Score Top-9 direkt")

        print("B = Top-27 / DiversityBonus 0.50")

        print("C = Top-27 / DiversityBonus 0.75")

            print("D = Top-27 / DiversityBonus 1.00")

            print("E = Top-27 / Coverage Target")
        ...
        print(String(format: "B Bonus50 | %6d | %5.1f%% | %4d | %16d", controlBHas21, Double(controlBHas21) / Double(evaluatedDraws) * 100.0, controlBExact21, controlBThreePlus))

            print(String(format: "C Bonus75 | %6d | %5.1f%% | %4d | %16d", controlCHas21, Double(controlCHas21) / Double(evaluatedDraws) * 100.0, controlCExact21, controlCThreePlus))

            print(String(format: "D Bonus100| %6d | %5.1f%% | %4d | %16d", controlDHas21, Double(controlDHas21) / Double(evaluatedDraws) * 100.0, controlDExact21, controlDThreePlus))

            print(String(format: "E Coverage| %6d | %5.1f%% | %4d | %16d", controlEHas21, Double(controlEHas21) / Double(evaluatedDraws) * 100.0, controlEExact21, controlEThreePlus))
